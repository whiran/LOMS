...
import { getallorderdata, getallprocessingorderdata } from "@/app/actions/api/customers/getallorderdata";
...
export default async function DemoPage() {
  ...
  const result:Order[] = await getallprocessingorderdata(userid)
