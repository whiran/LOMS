...
//get the processing orders data all users based on admin this is for admin mis

export const getcusordersprocess = async(id: string) => {
  try{
    //get the customers created by the user and get the count of total orders.
    const userData = await prisma.user.findMany({
      where: {
...
//get the pending orders data all users based on admin this is for admin mis

export const getcusorderspending = async(id: string) => {
  try{
    //get the customers created by the user and get the count of total orders.
    const userData = await prisma.user.findMany({
      where: {
...
//get the complete orders data all users based on admin this is for admin mis

export const getcusorderscomplete = async(id: string) => {
  try{
    //get the customers created by the user and get the count of total orders.
    const userData = await prisma.user.findMany({
      where: {
