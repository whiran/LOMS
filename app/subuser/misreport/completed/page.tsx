...
import { getallcompletedorderdatasub, getallorderdatasub } from "@/app/actions/api/subuser/getsuborderlistformis";
...
export default async function DemoPage() {
  ...
  const result:Order[] = await getallcompletedorderdatasub(userid)
