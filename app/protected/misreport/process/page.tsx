...
import { getallprocessingorderdatashadcn, getcusordersshad } from "@/app/actions/api/shadcnformat";
...
export default async function DemoPage() {
  ...
  const result:Order[] = await getallprocessingorderdatashadcn(userid)
